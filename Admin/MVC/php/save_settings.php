...
if ($action == 'update_features') {
    ...
    $admin_id = $_SESSION['user_id'];
    $conn->query("INSERT INTO admin_logs (admin_id, action_type, description) VALUES ('$admin_id', 'ANNOUNCEMENT', 'Updated banner ($status_text): $msg')");
}
