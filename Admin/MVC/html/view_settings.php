<?php
// (Fetch settings logic - Keep existing)
// ... (Logic code from previous file) ...
$settings = [];
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
    ...
    <div class="card-box">
        ...
        <form action="../php/save_settings.php" method="POST">
            ...
            <textarea name="message" rows="3" placeholder="e.g. System maintenance scheduled..." 
                      style="width: 100%; padding: 10px; border-radius: 6px; border: 1px solid #ddd; margin-bottom: 15px;"><?php echo htmlspecialchars($ann_msg); ?></textarea>
            
            <div style="margin-bottom: 20px;">
                <label style="font-weight: 600; color: #444; margin-right: 10px;">Status:</label>
                <select name="is_active" style="padding: 8px; border-radius: 4px; border: 1px solid #ddd;">
